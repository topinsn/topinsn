        ...
        <div class="row">
            ...
            <div class="col-md-8 justify-content-evenly">
                <p style="text-align: justify;">
                    ...
                    Responsive Layouts). As a linguist, I understand the importance of clarity, and as an administrator, I learnt succinctness, which had been the compass behind my creations. <br><br> I always available to discuss your project.<br><br>

                </p>
                <button type="button" class="btn btn-success ">
                    <a href="contact.php" style="text-decoration:none;" class="text-light">Contact Me</a>
                </button>
            </div>
